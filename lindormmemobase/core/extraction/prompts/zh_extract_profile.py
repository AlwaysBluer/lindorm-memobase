...
""",
    ...
    (
        """
- 用户与SiLei已婚 [提及于2025/01/15，婚姻在2025/01/01]
""",
        AIUserProfiles(
            **{
                "facts": [
                    ...
                    },
                    {
                        "topic": "生活事件",
                        "sub_topic": "婚姻",
                        "memo": "与SiLei结婚 [提及于2025/01/15, 婚姻发生在2025/01/01]",
                    },
                ]
            }
        ),
    ...
    (
        """
- 用户曾下午3点与John开会 [提及于2024/10/11，会议在2024/10/10]
                ...
                "facts": [
                    {
                        "topic": "工作",
                        "sub_topic": "合作",
                        "memo": "用户正在与John开始一个新项目 [提及于2024/10/11] 并已经见过一次面 [会议在2024/10/10]",
                    }
                ]
            }
        ),
